...
Este é um projeto de HTML e CSS básico para a construção de um modelo genérico de site temático para restaurantes montado com o objetivo de levar adiante estudos pessoais revisando conceitos básicos das tecnologias aqui envolvidas.
